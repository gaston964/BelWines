...
function dataProduc(product) {
    const infoProd = {
        ...
        precio: Number(product.querySelector(".price").innerText),
...
const actualizarCarrito = () => {
    ...
    carrito.forEach((prod) => {
        ...
        <p>Total: ${total}</p>
        <button onclick = "eliminarDelCarrito(${id})" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
